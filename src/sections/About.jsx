...
const AboutMe = () => {
  return (
    ...
    >
      ...
      {/* Main Grid */}
      <div className="relative z-10 max-w-6xl w-full grid gap-4 md:gap-4 grid-cols-1 lg:grid-cols-4">
        {/* Header */}
        <div
          className="lg:col-span-4 bg-[#cbbaad] rounded-2xl shadow p-6 flex items-center justify-center 
                        h-[100px] sm:h-[110px] md:h-[130px] lg:h-[150px]"
        >
          <h1 className="text-6xl Zumma sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-wide text-black">
            ABOUT ME
          </h1>
        </div>
        ...
        <div className="lg:col-span-1 flex flex-col gap-4">
          ...
          {/* Contact */}
          <div
            className="relative bg-[#cbbaad] rounded-2xl shadow p-6
              h-[160px] sm:h-[180px] md:h-[200px] lg:h-[220px] 
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          {/* Experience */}
          <div
            className="bg-[#cbbaad] rounded-2xl shadow p-8 sm:p-10 flex flex-col 
